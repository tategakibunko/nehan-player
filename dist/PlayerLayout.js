import { PhysicalSize } from 'nehan';
...
export function getScreenPageCount(layout) {
    switch (layout) {
        case "1x1": return 1;
        case "1x2":
        case "2x1": return 2;
...
export function getPageOrder(layout, writingMode) {
...
export function isMultiCol(layout) {
    return layout === "1x2" || layout === "2x2";
}
export function isMultiRow(layout) {
    return layout === "2x1" || layout === "2x2";
}
export function decGridCol(layout) {
    if (layout === "1x2") {
        return "1x1";
    }
    if (layout === "2x2") {
...
export function decGridRow(layout) {
    if (layout === "2x1") {
        return "1x1";
    }
    if (layout === "2x2") {
...
export function getElementLrPaddingSize(writingMode, layout, elementSize, fontSize, lineHeight, borderSize) {
...
export function getElementBottomPaddingSize(writingMode, layout, elementSize, fontSize, lineHeight, borderSize) {
    return fontSize * 1.5;
}
export function getPlayerSize(elementSize, fontSize, lrPadding, bottomPadding, borderSize) {
...
export function getPageSize(layout, playerSize) {
    switch (layout) {
...
export function getPlayerStyle(writingMode, playerSize, fontSize, lrPadding, bottomPadding, borderSize) {
...
export function getGridStyle(layout, playerSize) {
...
//# sourceMappingURL=PlayerLayout.js.map